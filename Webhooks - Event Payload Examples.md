...
&#xNAN;_&#x50;urpose:_ notify the merchant that a new client was created.
...
&#xNAN;_&#x50;urpose:_ notify that the client moved to pending verification.
...
&#xNAN;_&#x50;urpose:_ notify that the client was successfully verified.
...
&#xNAN;_&#x50;urpose:_ notify that the client was frozen.
...
&#xNAN;_&#x50;urpose:_ notify that order processing has started.
...
&#xNAN;_&#x50;urpose:_ notify that the order was completed successfully.
...
&#xNAN;_&#x50;urpose:_ notify that the order expired.
...
&#xNAN;_&#x50;urpose:_ notify about unsuccessful order completion in the current flow.
...
&#xNAN;_&#x50;urpose:_ backward compatibility with the legacy error model.
...
&#xNAN;_&#x50;urpose:_ notify that an input operation was selected for execution.
...
&#xNAN;_&#x50;urpose:_ notify that an input operation is in progress.
...
&#xNAN;_&#x50;urpose:_ notify that an input operation completed successfully.
...
&#xNAN;_&#x50;urpose:_ notify that an input operation failed.
...
&#xNAN;_&#x50;urpose:_ notify that an input operation expired.
...
&#xNAN;_&#x50;urpose:_ notify that an output operation was selected for execution.
...
&#xNAN;_&#x50;urpose:_ notify that an output operation is in progress.
...
&#xNAN;_&#x50;urpose:_ notify that an output operation completed successfully.
...
&#xNAN;_&#x50;urpose:_ notify that an output operation failed.
...
&#xNAN;_&#x50;urpose:_ notify that an output operation expired.
...
&#xNAN;_&#x50;urpose:_ notify that card/payment method binding has started.
...
&#xNAN;_&#x50;urpose:_ deliver successful binding result and `paymentToken`.
...
&#xNAN;_&#x50;urpose:_ notify about binding failure with card/provider diagnostic fields.
...
&#xNAN;_&#x50;urpose:_ deliver KYC/AML review result to merchant systems.
...
&#xNAN;_&#x50;urpose:_ synchronize the updated email in merchant systems.
