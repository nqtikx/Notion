...
```json
{
    "quoteId": "59f49049-63e8-4e76-8fa1-1fbc0572ddf1",
    "fromAsset": {
        "code": "TRX",
        "network": "Tron",
        "amount": "150"
    ...
    "expirationDate": "2026-04-27T11:40:58+0000"
}
```
...
| (Optional) failureDepositAddress - where the crypto will return in case of an error | {{walletAddress1}} |
| quoteId | {{quoteId}} |

(Optional) failureDepositAddress - where the crypto will return in case of an error
