...
```json
{
    "fromMinAmount": "35.344533",
    "fromMaxAmount": "14137.807387",
    "toMinAmount": "921.05",
    "toMaxAmount": "368421.05"
}
```
### Step 5. Create quote (v3)
**POST** {{URL}}/api/v3/exchange/merchant/quote
...
```json
{
    "id": "7a4f6a6b-3f16-4c6a-9d13-c9a05a25e6fc",
    "rate": "TRX/RUB",
    "systemRateValue": "26.5829",
    "exchangeRateValue": "26.5829",
    "actualRateValue": "26.1841",
    "clientId": "3e1469fa-8d35-441c-87b1-a007aeba2562",
    "creationDate": "2026-04-25T14:07:53+0000",
    "expirationDate": "2026-04-25T14:08:23+0000",
    "input": {
        "type": "CRYPTO_TRANSFER",
        "asset": "TRX",
        "amount": "70",
    ...
    "output": {
        ...
        "feeAmount": "27.91",
        "provider": "CA",
        "token": "59676b7a-da24-4916-8236-1efef6796009",
        "paymentType": null,
        "processingBank": null
    }
}
...
```json
{
    ...
    "failureMessage": null,
    "completionDate": null,
    "creationDate": "2026-04-25T14:08:04+0000",
    "sessionId": null,
    "input": {
        "type": "CRYPTO_TRANSFER",
        "asset": "TRX",
        ...
        "status": "PROCESSING",
        "failureMessage": null,
        "expirationDate": "2026-04-25T14:38:04+0000",
        "fromAddress": null,
    ...
    "output": {
        ...
        "clientBank": null,
        "fromToken": null,
        "toToken": "59676b7a-da24-4916-8236-1efef6796009",
        "link": null,
        "processorTransactionId": "c4032d1c-8234-4723-ae60-6c09814a911d",
        "post": null,
        "paymentSystem": null
    }
}
...
```json
{
    ...
    "input": {
        ...
        "failureMessage": null,
        "expirationDate": null,
        "fromAddress": "TCT2pKJXo233hrKWQMeCptC8My1KGvtsU4",
        "toAddress": "TSaysSYUgBoKbtBgnXdxvNQPjkeXC1s9eM",
        "comment": null,
        "hash": "b3a97dc4985e66278ffc2966aee1a2e130301f6b8322c7430c681ac870850511"
    },
    "output": {
        "type": "FIAT_PROVIDER",
        "asset": "RUB",
